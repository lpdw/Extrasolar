    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/a')) {
            if (0 === strpos($pathinfo, '/api')) {
                // api
                if ($pathinfo === '/api') {
                    return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::apiAction',  '_route' => 'api',);
                }
                ...
                if ($pathinfo === '/api') {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_api_planete;
                    }

                    return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::apiGetListPlaneteAction',  '_route' => 'api_planete',);
                }
                not_api_planete:

                // app_default_apigetlistplanete
                if (preg_match('#^/api/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_app_default_apigetlistplanete;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'app_default_apigetlistplanete')), array (  '_controller' => 'AppBundle\\Controller\\DefaultController::apiGetListPlaneteAction',));
                }
                not_app_default_apigetlistplanete:

                // app_default_apigetlistplanete_1
                if (preg_match('#^/api/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_app_default_apigetlistplanete_1;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'app_default_apigetlistplanete_1')), array (  '_controller' => 'AppBundle\\Controller\\DefaultController::apiGetListPlaneteAction',));
                }
                not_app_default_apigetlistplanete_1:

                // app_default_apigetlistplanete_2
                if (preg_match('#^/api/(?P<id>[^/]++)/(?P<props>[^/]++)$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_app_default_apigetlistplanete_2;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'app_default_apigetlistplanete_2')), array (  '_controller' => 'AppBundle\\Controller\\DefaultController::apiGetListPlaneteAction',));
                }
                not_app_default_apigetlistplanete_2:
